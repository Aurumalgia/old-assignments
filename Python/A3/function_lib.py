...
def askProcessingType(prompt="How would you like to change your image? \n1: Grayscale\n2: Inversed\n"):
    userIn = input(prompt)
    userIn.strip()
    if userIn == '1':
        return grayPixel
    elif userIn == '2':
        return negativePixel
    return askProcessingType(prompt="Invalid input - Please enter '1' for Grayscale or '2' for Inversed\n")
